// Thunder sign-in — OIDC Authorization Code + PKCE via oidc-client-ts.
// mock/auth.ts substitutes this whole module under `--mode mock` (no IDP, no
// cluster); every other module reaches auth only through the functions below.
